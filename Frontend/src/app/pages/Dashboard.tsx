  ...
  export function Dashboard() {
    ...
    const cargarDashboard = async () => {
      ...
      try {
        ...
        setTotalTransferencias(data.totalTransferencias || 0);
            ...
            <CardContent className="py-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-semibold text-success">+{formatCurrency(totalIngresos)}</p>
                </div>
            ...
            <CardContent className="py-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-semibold text-destructive">-{formatCurrency(totalGastos)}</p>
                </div>
